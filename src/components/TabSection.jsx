...
export class TabSection extends Component {
    ...
    <div className="RightTabContainer">
      ...
      <h1>HEIGHT</h1>
      <p>The Rottweiler stands 61–69 cm (24–27 in) at the withers for males, 56–63 cm (22–25 in) for females
      </p>
    ...
    <div className="RightTabContainer">
      ...
      <p>As much as you might fancy owning a regal Rottweiler forever, there are definitely cases where a Rottie IS NOT the dog for you! These are some examples that show when it is not the right time to acquire a Rottweiler
      </p>
    ...
    <div className="RightTabContainer">
      ...
      <p>The Rottweiler is one of the oldest of herding breeds. With a history possibly dating back to the Roman Empire, the Rottweiler may be a descendant of ancient Roman drover dogs; a mastiff-type dog that was a dependable, rugged dog with great intelligence and guarding instincts.
      </p>
